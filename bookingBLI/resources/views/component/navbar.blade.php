...
<style>
    .nav-link {
        ...
        padding-bottom: 4px; /* Ensure space for underline */
    }
    ...
    .nav-link::after {
        ...
        transition: width 0.3s ease-in-out, left 0.3s ease-in-out, background-color 0.3s;
    }
...
<div class="hidden lg:flex gap-8 md:gap-14 text-[16px] md:text-[18px] font-semibold tracking-[1.08px] ml-auto">
    <a href="/favorite" class="nav-link {{ Request::is('favorite') ? 'active' : '' }} hover:text-gray-300 hover:scale-110 transition-transform duration-200">FAVORITE</a>
    <a href="/room" class="nav-link {{ Request::is('room') ? 'active' : '' }} hover:text-gray-300 hover:scale-110 transition-transform duration-200">BOOK</a>
    <a href="/history" class="nav-link {{ Request::is('history') ? 'active' : '' }} hover:text-gray-300 hover:scale-110 transition-transform duration-200">HISTORY</a></div>
